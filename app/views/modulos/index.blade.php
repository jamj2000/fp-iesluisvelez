...
$(document).ready(function() {
    ...
    $("#cursos a").hide(); // hide all the events
    $(".1gm").show();      // mostramos clase 1gm
...
<div class="event btn-group">
  <button  id="1gm"   class="btn btn-default">1FPGM</button>
  ...
  <div class="panel-heading alto55">
	...
	@foreach($modulos as $key => $value)
		{{-- */$clase='';/* --}}  {{-- Truco para declarar variables haciendo uso del los comentarios de Blade --}}
	      @if (strpos($value->curso,'1FPGM') !== false)
		{{-- */$clase='todos 1gm list-group-item';/* --}}
