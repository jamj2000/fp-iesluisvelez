...
<script>  
  $(document).ready(function () {
	...
	<div class="jumbotron">
		...
		<!-- Si el usuario actual es el profesor que imparte el módulo o el administrador entonces puede editar el módulo -->
		@if (Auth::user()->id == $modulo->profesor_id or Auth::user()->admin == 's' )
